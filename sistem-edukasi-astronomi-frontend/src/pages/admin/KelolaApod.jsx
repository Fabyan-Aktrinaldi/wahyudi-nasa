    ...
    <div className="min-vh-100 bg-dark text-white p-4">
      ...
      <div className="card bg-secondary text-white mb-4">
        <div className="card-body">
          <h5 className="mb-2">Konfigurasi NASA API</h5>
          <p className="text-white-50 mb-2">
            APOD menggunakan NASA API. Saat ini menggunakan:{' '}
            <code>{import.meta.env.VITE_NASA_KEY ? 'Custom API Key' : 'DEMO_KEY (limit 30 req/jam)'}</code>
          </p>
          <small className="text-white-50">
            Untuk set API key, tambahkan <code>VITE_NASA_KEY=your_key</code> di file <code>.env</code> frontend,
            lalu dapatkan key gratis di{' '}
            <a href="https://api.nasa.gov" target="_blank" rel="noreferrer" className="text-white">api.nasa.gov</a>.
          </small>
        </div>
      </div>
