...
export default function AppRoutes() {
  return (
    <BrowserRouter>
      <Routes>
        {/* Landing & Login — tanpa Navbar/Footer */}
        ...
        <Route path="/admin/artikel" element={
          <ProtectedRoute><AdminLayout><KelolaArtikel /></AdminLayout></ProtectedRoute>
        } />
        <Route path="/admin/kategori" element={
          <ProtectedRoute><AdminLayout><KelolaKategori /></AdminLayout></ProtectedRoute>
        } />
        <Route path="/admin/apod" element={
          <ProtectedRoute><AdminLayout><KelolaApod /></AdminLayout></ProtectedRoute>
        } />
      </Routes>
    </BrowserRouter>
  );
