  ...
  return (
    ...
    >
      ...
      <div className="d-flex align-items-center gap-4">
        <Link to="/home" className="text-white-50 text-decoration-none small hover-white" style={{ letterSpacing: '0.08em' }}>
          Beranda
        </Link>
        <Link to="/artikel" className="text-white-50 text-decoration-none small" style={{ letterSpacing: '0.08em' }}>
          Artikel
        </Link>
        <Link to="/apod" className="text-white-50 text-decoration-none small" style={{ letterSpacing: '0.08em' }}>
          APOD
        </Link>
        <button
